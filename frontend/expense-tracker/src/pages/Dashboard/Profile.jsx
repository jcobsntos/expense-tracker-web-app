...
import { FaUser, FaCamera, FaLock, FaSave, FaExclamationCircle, FaCheckCircle } from 'react-icons/fa';
          ...
          <div className="p-8">
            ...
            {error && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="flex items-center gap-2 bg-red-100 text-red-700 px-4 py-3 rounded-lg mb-6 border border-red-300"
              >
                <FaExclamationCircle />
                <span>{error}</span>
              </motion.div>
            ...
            {success && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="flex items-center gap-2 bg-green-100 text-green-700 px-4 py-3 rounded-lg mb-6 border border-green-300"
              >
                <FaCheckCircle />
                <span>{success}</span>
              </motion.div>
            ...
            {activeTab === 'profile' && (
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-6 p-6 bg-gray-50 rounded-xl">
